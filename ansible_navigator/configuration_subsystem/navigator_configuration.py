...
NavigatorConfiguration = ApplicationConfiguration(
    ...
    entries=[
        ...
        Entry(
            ...
            apply_to_subsequent_cli=C.SAME_SUBCOMMAND,
            settings_file_path_override="runner.artifact_dir",
            short_description="The directory path to store artifacts generated by ansible-runner",
            value=EntryValue(),
        ),
        Entry(
            name="runner_rotate_artifacts_count",
            apply_to_subsequent_cli=C.SAME_SUBCOMMAND,
            settings_file_path_override="runner.rotate_artifacts_count",
            short_description="Keep runner artifact directories, "
        ...
        Entry(
            name="runner_timeout",
            apply_to_subsequent_cli=C.SAME_SUBCOMMAND,
            settings_file_path_override="runner.timeout",
